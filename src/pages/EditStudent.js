...
function EditStudent(props) {
    ...
    const { data:student } = useQuery(FETCH_STUDENT_QUERY, {
        variables: {
            postId
        }
    })
    ...
    useEffect(() => {
            ...
            if(student) {
              console.log(student+'2')
                setGetStudent(student.getStudent)
            }
    
            const { childname, klass, age, sin, gender, state, childstatus, 
              healthstatus, hostelName, image, quranStatus, relationshipone, fname, 
              foccupation, fphone, faddress, relationshiptwo, sname, soccupation, sphone, saddress, iname, iphone } = student.getStudent
